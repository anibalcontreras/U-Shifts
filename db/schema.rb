...
ActiveRecord::Schema.define(version: 2022_06_11_234620) do
  ...
  create_table "chats", force: :cascade do |t|
    ...
    t.index ["turno_id"], name: "index_chats_on_turno_id"
  end
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.index ["turno_id"], name: "index_members_on_turno_id"
  ...
  create_table "requests", force: :cascade do |t|
    ...
    t.index ["solicitante_id"], name: "index_requests_on_solicitante_id"
  ...
  add_foreign_key "chats", "turnos"
  add_foreign_key "members", "turnos"
  add_foreign_key "members", "users"
  add_foreign_key "messages", "chats"
  add_foreign_key "messages", "users", column: "sender_id"
  add_foreign_key "requests", "turnos"
  add_foreign_key "requests", "users", column: "solicitante_id"
